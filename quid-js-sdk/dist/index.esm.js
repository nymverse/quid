...
const QuIDSigninButton = ({ challenge, userVerification = 'preferred', timeout = 60000, onSuccess, onError, style = {}, buttonText = 'Sign in with QuID', showBranding = true, className = '', disabled = false, children, ...props }) => {
    ...
    const buttonContent = children || (jsxs(Fragment, { children: [showBranding && jsx("span", { style: { fontSize: '18px' }, children: "\uD83D\uDD10" }), jsx("span", { children: isLoading ? 'Authenticating...' : buttonText }), isLoading && (jsx("div", { style: {
                    width: '16px',
                    height: '16px',
                    border: '2px solid transparent',
    ...
    return (jsxs("div", { children: [jsx("button", { type: "button", onClick: handleClick, disabled: disabled || isLoading || !isReady, className: `quid-signin-button ${className}`, style: defaultStyle, ...props, children: buttonContent }), showWarning && (jsxs("div", { style: {
                    background: '#fff3cd',
                    border: '1px solid #ffeaa7',
                    color: '#856404',
                    padding: '8px 12px',
                ...
                }, children: ["\u26A0\uFE0F QuID browser extension not detected.", ' ', jsx("a", { href: "https://quid.dev/download", target: "_blank", rel: "noopener noreferrer", style: { color: 'inherit', textDecoration: 'underline' }, children: "Install extension" }), ' ', "for full functionality."] })), jsx("style", { jsx: true, children: `
        @keyframes spin {
          0% { transform: rotate(0deg); }
          100% { transform: rotate(360deg); }
        }
...
function useQuID(options = {}) {
    ...
    const createIdentity = useCallback(async (request) => {
        if (!clientRef.current) {
            throw new Error('QuID client not initialized');
        }
        setIsLoading(true);
...
export { EventEmitter, ExtensionConnector, Logger, QuIDClient$2 as QuIDClient, QuIDOAuthClient, QuIDSigninButton$1 as QuIDSigninButton, QuIDSigninButton as QuIDSigninButtonReact, QuIDSigninButton as QuIDSigninButtonReactDefault, WebAuthnBridge, createSigninButton, QuIDClient$1 as default, useQuID, useQuID as useQuIDDefault };
